...
public class Human implements Actions {
    ...
    private final static double DEFAULT_MAX_JUMP = 1.3;

    private final static String TYPE = "Человек";
    ...
    public Human(String name, int maxRunDistance, double maxJumpDistance) {
        this.name = name;

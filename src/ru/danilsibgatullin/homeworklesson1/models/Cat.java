...
public class Cat implements Actions {
    ...
    private final static int DEFAULT_MAX_RUN = 100;
    private final static double DEFAULT_MAX_JUMP = 1.8;

    private final static String TYPE = "Кот";
    ...
    public Cat(String name, int maxRunDistance, double maxJumpDistance) {
        this.name = name;
